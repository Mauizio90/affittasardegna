export const en ={
    ...
    "suggestP1": "Are you the owner of a holiday home or a villa and would like to turn it into an income?",
    "suggestP2": "You're in the right place!",
    ...
    "termsP3": "The reservation is considered confirmed only when the customer receives a confirmation email from AffittaSardegna. The reservation is subject to the prior confirmation of accommodation availability by AffittaSardegna. Following the reservation request, AffittaSardegna will send the customer the 'reservation form.' By sending the 'reservation form,' the customer is required to pay the deposit indicated in the RESERVATION FORM via bank transfer/credit card. Payment must be made in the manner and within the times specified in the 'reservation form.' The reservation confirmation occurs when AffittaSardegna receives a copy of the customer's deposit payment receipt; the copy must be sent within one week from the sending of the 'reservation form.' In the absence of sending this copy, the reservation request will be considered canceled. The balance must be paid in the manner and within the times specified in the 'reservation form,' always by bank transfer/credit card. The non-payment of the above amounts, in the manner and times indicated, results in the automatic termination of any relationship, also authorizing AffittaSardegna to retain the amounts received as per applied tariff conditions. For reservation requests made within the 30 days before the start date of the stay, the corresponding price must be paid in full upon receipt of the 'reservation form.' The customer must always proceed with the full payment of the reservation price directly to AffittaSardegna, which will issue a regular payment receipt/invoice. All prices are in Euros. Property reservations are nominative and not transferable to third parties without the prior authorization of AffittaSardegna or the owner of the property. In the case of luxury homes, payment terms, as well as cancellation conditions, may vary on a case-by-case basis; they will be communicated each time.",
    ...
    "termsP16": "Cancellation made by the customer for bookings confirmed with the STANDARD RATE will incur the following penalties, always calculated on the total amount of the stay: <br>- 20% of the amount if the cancellation is communicated up to 91 days before the start date of the stay; <br>- 50% of the amount if the cancellation is communicated from 31 to 90 days before the start date of the stay; <br>- 100% of the amount: no refund for cancellations received within 30 days before the start date of the stay.<br>For penalty purposes, the entire stay is considered as a single indivisible period over the individual weeks; the reference date for counting the days is always the start date of the stay, regardless of the canceled period; changes in period or accommodation are considered cancellations and therefore the corresponding penalties will be applied. To cancel a reservation, the customer must send an email to info@affittasardegna.it, indicating the reservation number and the name of the person who made the reservation. Phone cancellations are not allowed.",
    ...
    "aboutUsMetaTitle": "AffittaSardegna - About us",
    ...
    "accommodationsMetaTitle": "AffittaSardegna - Accommodations",
    ...
    "contactsMetaTitle": "AffittaSardegna - Contact Us",
    ...
    "locationsMetaTitle": "AffittaSardegna - Locations",
    ...
    "propertySuggestionMetaTitle": "AffittaSardegna - Propose Property",
    ...
    "recensioni" : "Reviews",
    "cheDicono" : "What They Say About Us",
    "recensioneRoberta": "The apartment where my family and I stayed at the end of August was clean and welcoming, in an excellent and strategic location, everything was exactly as described on the website. It's a peaceful place and perfect for those who, like me, want to relax during their vacation. I felt at home. The local contact was professional, kind, and available all day for any information, questions, or doubts. If I had to go back, I would do so gladly! Highly recommended =)",
    "recensioneJan": "We stayed in Orosei last year at Casa del Dottore. The house was very big, clean and we all felt very comfortable. The agency AffittaSardegna Soc. Coop was very helpful all the time and the communication went very well. All people were very nice! Orosei was a very nice Place to spent the holidays. It was not too crowded and had really beautiful beaches close to the house (by car 5 min). We had a really nice time and can highly recommend everything!",
    ...
    "proponiText": "Renting a property for short-term stays comes with many duties and responsibilities, but with us by your side, you can sit back, relax, and let the home work for you! If you also have a vacation home that matches the characteristics sought by our guests and meets our market standards, we need to get to know each other!</p><p>Over time, we have learned to find a common ground between the needs of those who choose to rent their home or villa in Sardinia and thousands of tourists from all over the world, making their satisfaction our priority and establishing a relationship of mutual trust and harmonious, as well as profitable, collaboration. This result is possible thanks to the great flexibility of the agreements that can be established with property owners, each customized based on the requests and needs expressed.</p><p>Entrusting yourself to AffittaSardegna means enjoying the visibility and publicity that AffittaSardegna guarantees across all its channels, at no subscription cost. You will also be relieved from worrying about all the tax, bureaucratic, and administrative aspects that managing a vacation home entails by law (and the associated risks if not complied with), commitments we will take care of in the expected time and manner!</p><p><strong>Curious to learn more? Join AffittaSardegna too! Fill out the form, and a member of our team will contact you right away!</strong><br>",
    "bedIcon": "Rooms",
    "bathIcon": "Bathrooms",
